##### This file is made by following the tutorial ###########
...
import caffe
# If you get "No module named _caffe", either you have not built
#pycaffe or you have the wrong path.
...
'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'):
    ...
    subprocess.call("../scripts/download_model_binary.py ../models/bvlc_reference_caffenet", shell=True)
...
########### Start to define the network here ############
...
# define the workdir and write *.prototxt in this directory
workdir = './pascal_multilabel_with_datalayer'
if not os.path.isdir(workdir):
    os.makedirs(workdir)

solverprototxt = tools.CaffeSolver(trainnet_prototxt_path = osp.join(workdir,
"trainnet.prototxt"), testnet_prototxt_path = osp.join(workdir,
"valnet.prototxt"))
solverprototxt.sp['display'] = "1"
solverprototxt.sp['base_lr'] = "0.0001"
solverprototxt.sp['solver_mode'] = "CPU"
solverprototxt.write(osp.join(workdir, 'solver.prototxt'))

# write train net.
with open(osp.join(workdir, 'trainnet.prototxt'), 'w') as f:
    # provide parameters to the data layer as a python dictionary. Easy as pie!
    data_layer_params = dict(batch_size = 2, im_shape = [227, 227], split =
'train', pascal_root = pascal_root)
...
with open(osp.join(workdir, 'valnet.prototxt'), 'w') as f:
    data_layer_params = dict(batch_size = 2, im_shape = [227, 227], split =
'val', pascal_root = pascal_root)
    f.write(caffenet_multilabel(data_layer_params,
'PascalMultilabelDataLayerSync'))

##### This net uses a python datalayer: 'PascalMultilabelDataLayerSync', which
##### is defined in './pycaffe/layers/pascal_multilabel_datalayers.py'

# Solver
solver = caffe.SGDSolver(osp.join(workdir, 'solver.prototxt'))
solver.net.copy_from(caffe_root +
'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel')
